...
Future<void> main() async {
  ...
  runApp(const OpusFlutterWidget());
}
...
class OpusFlutterWidget extends StatelessWidget {
  const OpusFlutterWidget({super.key});
...
class OpusExampleWidget extends StatefulWidget {
  const OpusExampleWidget({super.key});

  @override
  State<OpusExampleWidget> createState() => _OpusExampleState();
}

class _OpusExampleState extends State<OpusExampleWidget> {
